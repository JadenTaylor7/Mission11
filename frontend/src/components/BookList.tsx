      ...
      {books?.map((i) => (
        <div id="bookCard" className="card" key={i.bookID}>
          ...
          <div className="card-body">
            ...
            <button className="btn btn-success" onClick={() => navigate(`/donate/${i.bookID}/${i.title}/${i.price}`)}>Checkout</button>
          </div>
        </div>
      ))}
      <br />
...
//                             <button className="btn btn-success" onClick={() => navigate(`/donate/${i.title}/${i.bookID}/${i.price}`)}>Checkout</button>
//                         </div>
